...
#ifdef PGSPIDER
__thread char *datestyle_string;
#else
...
#ifdef PGSPIDER
__thread struct config_bool ConfigureNamesBool[] =
#else
...
#ifdef PGSPIDER
__thread struct config_int ConfigureNamesInt[] =
#else
...
#ifdef PGSPIDER
__thread struct config_real ConfigureNamesReal[] =
#else
...
#ifdef PGSPIDER
__thread struct config_string ConfigureNamesString[] =
#else
...
#ifdef PGSPIDER
__thread struct config_enum ConfigureNamesEnum[] =
#else
