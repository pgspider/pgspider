...
-- pgspider_fdw can pushdown user-defined function because of it supports
-- tlist function pushdown feature
EXPLAIN (VERBOSE, COSTS OFF)
...
ALTER EXTENSION pgspider_fdw ADD TEXT SEARCH CONFIGURATION public.custom_search;
...
-- tlist function pushdown feature
EXPLAIN (VERBOSE, COSTS OFF)
SELECT * FROM local_tbl LEFT JOIN (SELECT ft1.* FROM ft1 INNER JOIN ft2 ON (ft1.c1 = ft2.c1 AND ft1.c1 < 100 AND (ft1.c1 - pgspider_fdw_abs(ft2.c2)) = 0)) ss ON (local_tbl.c3 = ss.c3) ORDER BY local_tbl.c1 FOR UPDATE OF local_tbl;
