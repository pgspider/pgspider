...
#ifdef PGSPIDER
PG_CMDTAG(CMDTAG_CREATE_DATASOURCE_TABLE, "CREATE DATASOURCE TABLE", false, false, false)
#endif
...
#ifdef PGSPIDER
PG_CMDTAG(CMDTAG_DROP_DATASOURCE_TABLE, "DROP DATASOURCE TABLE", false, false, false)
#endif
...
#ifdef PGSPIDER
PG_CMDTAG(CMDTAG_MIGRATE_TABLE, "MIGRATE TABLE", false, false, false)
#endif
