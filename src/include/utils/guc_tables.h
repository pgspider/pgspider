...
#ifdef PGSPIDER
extern PGDLLIMPORT __thread struct config_bool ConfigureNamesBool[];
extern PGDLLIMPORT __thread struct config_int ConfigureNamesInt[];
extern PGDLLIMPORT __thread struct config_real ConfigureNamesReal[];
extern PGDLLIMPORT __thread struct config_string ConfigureNamesString[];
extern PGDLLIMPORT __thread struct config_enum ConfigureNamesEnum[];
#else
...
#ifdef PGSPIDER
extern PGDLLIMPORT __thread char *datestyle_string;
#endif
