...
#ifdef PGSPIDER
	[MCTX_ASET_ID].free_context_list = AllocSetFreeContextList,
#endif
...
#ifdef PGSPIDER
	[MCTX_GENERATION_ID].free_context_list = GenerationFreeContextList,
#endif
...
#ifdef PGSPIDER
	[MCTX_SLAB_ID].free_context_list = SlabFreeContextList,
#endif
 ...
 */
static bool
string_exist_in_list(const char *str, const char **strlist)
{
	int			i;
