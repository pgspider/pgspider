...
PG_KEYWORD("child", CHILD, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("distributed_func", DISTRIBUTED_FUNC, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("parent", PARENT, UNRESERVED_KEYWORD, BARE_LABEL)
