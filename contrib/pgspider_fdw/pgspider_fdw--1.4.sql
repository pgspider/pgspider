/* contrib/pgspider_fdw/pgspider_fdw--1.4.sql */
...
CALL pgspider_create_or_replace_stub('vf', 'mysql_format(double precision, int)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_format(double precision, int, text)', 'text');
...
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_instr(text, text)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_instr(text, text, int)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_instr(text, text, int, int)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_instr(text, text, int, int, int)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_instr(text, text, int, int, int, text)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_like(text, text)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_like(text, text, text)', 'int');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_replace(text, text, text)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_replace(text, text, text, int)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_replace(text, text, text, int, int)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_replace(text, text, text, int, int, text)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_substr(text, text)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_substr(text, text, int)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_substr(text, text, int, int)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_regexp_substr(text, text, int, int, text)', 'text');
...
CALL pgspider_create_or_replace_stub('vf', 'mysql_json_value(json, text)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_json_value(json, text, text)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_json_value(json, text, text, text)', 'text');
CALL pgspider_create_or_replace_stub('vf', 'mysql_json_value(json, text, text, text, text)', 'text');
